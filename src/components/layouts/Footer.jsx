  ...
  return (
    <footer>
      <div className="relative -mb-5 min-h-[30vh] w-full border-t border-neutral-700 bg-dark text-light dark:bg-neutral-900">
        <div className="mx-auto mb-5 flex w-2/3 flex-col gap-16 px-10 py-10 pb-20 md:w-full md:flex-row md:justify-between md:gap-0 md:px-20 lg:px-40">
          ...
          <div className="contact mr-auto w-full flex-1 gap-3 md:w-0">
            ...
            <p className="text-sm">
              No. Hp : 0812 3456 789 <br /> Email : ponpesattanwir@example.com
            </p>
          </div>
        </div>
