...
function Navbar() {
  ...
  return (
    <nav>
      <div
        className={`fixed left-0 right-0 top-0 z-50 flex items-center justify-between bg-primary px-5 py-4 font-montserrat md:px-10 ${showMenu || scrolled ? "" : "delay-500"} ${scrolled ? "bg-primary shadow-md dark:bg-[#344e41]" : "bg-transparent"}`}
      >
